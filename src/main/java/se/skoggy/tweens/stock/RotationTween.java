...
public class RotationTween  extends Tween{
	...
	public RotationTween(ITweenable subject, Interpolation interpolation, float duration, float start, float end) {
	...
	public void tween(float progress, ITweenable subject, Interpolation interpolation) {
		subject.setRotation(interpolation.apply(start, end, progress));
	}
